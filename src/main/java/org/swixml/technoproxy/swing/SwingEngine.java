...
public class SwingEngine
        extends
        ProxyCode<org.swixml.SwingEngine<Container, Component, ActionListener, JLabel, ButtonGroup, LayoutManager>> {

    public SwingEngine (
            org.swixml.SwingEngine<Container, Component, ActionListener, JLabel, ButtonGroup, LayoutManager> source1) {
        super (source1);
    }
